...
```bash
vllm serve ylfeng/ReF-Decompile --port 8000 --enable-auto-tool-choice --tool-call-parser mistral
python eval/eval.py --base_url http://127.0.0.1:8000/v1
```

## Build Data

```bash
python train/stage1_compile.py
python train/stage2_build.py
```
